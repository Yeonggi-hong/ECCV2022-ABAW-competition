...
from networks.dan import DAN_ab
...
def parse_args():
    ...
    parser.add_argument('--train_path', type=str, default='../datasets/train', help='train dataset path.')
    parser.add_argument('--val_path', type=str, default='../datasets/valid', help='val dataset path.')
...
def run_training():
    ...
    model = DAN_ab(num_class=args.num_class, num_head=args.num_head, pretrained=args.pretrained)
